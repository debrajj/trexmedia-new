      ...
      <Section id="how-to-use">
        <div className="container">
          <Heading
            ...
            text="Trexx IT Pro unlocks the potential of AI-powered applications"
          />
            ...
            <div className="relative z-1 flex items-center mb-5 p-8 h-[39rem] xl:h-[46rem] border border-n-1/10 lg:p-20 rounded-3xl overflow-hidden">
              ...
              <div className="relative z-1 max-w-[17rem] ml-auto">
                ...
                <p className="body-2 text-n-3 mt-4 mb-[3rem]">
                  Trexx IT Pro unlocks the potential of AI-powered applications
                </p>
                <ul className="body-2">
                  {trexxITProServices.map((item, index) => (
                    <li
                      key={index}
              ...
              <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                <div className="py-12 px-4 xl:px-8">
                  ...
                  <ul className="flex items-center justify-between">
                    {trexxITProServicesIcons.map((item, index) => (
                      <li
                        key={index}
