      ...
      <div className="pt-[4.75rem] lg:pt-[5.25rem] overflow-hidden">
        ...
        <Section className="pt-[8rem]" crosses>
          <div className="container">
              ...
              {ispServices.map((service, index) => (
                ...
                >
                  <div className="relative p-8 h-full">
                    ...
                    <h3 className="h5 mb-3 text-center">{service.title}</h3>
            ...
            {/* CTA Section */}
            <div className="bg-n-8 rounded-[1rem] p-12 text-center border-2 mt-20" style={{borderColor: '#03BFFF'}}>
                <h3 className="h3 mb-4">Need a Custom Solution?</h3>
                <p className="body-1 text-n-3 mb-8 max-w-3xl mx-auto">
                  Our team of experts can design and implement tailored network solutions 
                  for your specific requirements. Let&apos;s discuss your project.
                </p>
                <Button white>Contact Our Team</Button>
            </div>
          </div>
        </Section>
